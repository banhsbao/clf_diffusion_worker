...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/diffusion-worker
```

A live public deployment of this template is available at [https://diffusion-worker.templates.workers.dev](https://diffusion-worker.templates.workers.dev)
